...
class OrderController extends Controller
{
    public function CashOrder(Request $request){
        ...
        $order_id = Order::insertGetId([
            ...
            'amount' => $totalAmount,
            'total_amount' => $tt,
            'invoice_no' => 'MUR' .mt_rand(10000000,99999999),
     ...
     public function StripeOrder(Request $request){
        ...
        \Stripe\Stripe::setApiKey('sk_test_51Qag0P3HRKqubLINukOY5RAOJ1JJa2VQZuDTOl295ueLDGIO1BwdGHtL9816oKxs8tFGzaaMXB3gtevVyI4qPXET00IpuMcCvl');
